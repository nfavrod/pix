...
define('mon-pix/routes/campaigns/start-or-resume', ['exports', 'mon-pix/routes/base-route', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _baseRoute, _authenticatedRouteMixin) {
  ...
  exports.default = _baseRoute.default.extend(_authenticatedRouteMixin.default, {
    model: function model(params) {
      var codeCampaign = params.campaign_code;
      var store = this.get('store');
      return store.query('assessment', { filter: { type: 'SMART_PLACEMENT' } }).then(function (smartPlacementAssessments) {
        if (!Ember.isEmpty(smartPlacementAssessments)) {
          var findCampaignAssessment = smartPlacementAssessments.find(function (assessment) {
            return assessment.codeCampaign === codeCampaign;
          });
          if (findCampaignAssessment) {
            return findCampaignAssessment;
          }
        }
        return store.createRecord('assessment', { type: 'SMART_PLACEMENT', codeCampaign: codeCampaign }).save();
      });
    },
    afterModel: function afterModel(assessment) {
      var _this = this;
