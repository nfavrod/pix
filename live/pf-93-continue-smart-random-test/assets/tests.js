  ...
  (0, _mocha.describe)('Unit | Model | assessment progress', function () {
    ...
    (0, _mocha.describe)('@_currentStep', function () {
      ...
      (0, _mocha.context)('when assessment type is "SMART_PLACEMENT"', function () {
        ...
        (0, _mocha.it)('should return 3 if number of answers is less than 5', function () {
          // given
        ...
        (0, _mocha.it)('should return 4 (a modulo of 5) if number of answers is more than 5', function () {
          // given
