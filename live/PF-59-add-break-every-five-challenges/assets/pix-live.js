...
define('pix-live/models/assessment', ['exports', 'ember-data'], function (exports, _emberData) {
  ...
  exports.default = Model.extend({
    ...
    answersSinceLastCheckpoints: Ember.computed('answers.[]', function () {
      ...
      var NUMBER_OF_CHALLENGES_IN_A_ROW = 5;

      var howManyAnswersSinceTheLastCheckpoint = this.get('answers.length') % NUMBER_OF_CHALLENGES_IN_A_ROW;
      var sliceAnsersFrom = howManyAnswersSinceTheLastCheckpoint === 0 ? -NUMBER_OF_CHALLENGES_IN_A_ROW : -howManyAnswersSinceTheLastCheckpoint;
      ...
      saveAnswerAndNavigate: function saveAnswerAndNavigate(challenge, assessment, answerValue, answerTimeout, answerElapsedTime) {
        ...
        return answer.save().then(function () {
          if (assessment.get('hasCheckpoints') && assessment.get('answers.length') % 5 === 0) {
            _this3.transitionTo('assessments.checkpoint', assessment.get('id'));
          } else {
