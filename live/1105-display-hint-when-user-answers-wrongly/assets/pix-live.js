...
define('pix-live/mirage/config', ['exports', 'pix-live/mirage/routes/get-answer', 'pix-live/mirage/routes/get-answer-by-challenge-and-assessment', 'pix-live/mirage/routes/get-assessment', 'pix-live/mirage/routes/get-assessment-solutions', 'pix-live/mirage/routes/get-user-me', 'pix-live/mirage/routes/get-challenge', 'pix-live/mirage/routes/get-challenges', 'pix-live/mirage/routes/get-course', 'pix-live/mirage/routes/get-courses', 'pix-live/mirage/routes/get-courses-of-the-week', 'pix-live/mirage/routes/get-next-challenge', 'pix-live/mirage/routes/get-organizations', 'pix-live/mirage/routes/get-snapshots', 'pix-live/mirage/routes/get-solutions', 'pix-live/mirage/routes/patch-answer', 'pix-live/mirage/routes/post-answers', 'pix-live/mirage/routes/post-assessments', 'pix-live/mirage/routes/post-authentications', 'pix-live/mirage/routes/post-certification-course', 'pix-live/mirage/routes/post-feedbacks', 'pix-live/mirage/routes/post-refresh-solution', 'ember-cli-mirage'], function (exports, _getAnswer, _getAnswerByChallengeAndAssessment, _getAssessment, _getAssessmentSolutions, _getUserMe, _getChallenge, _getChallenges, _getCourse, _getCourses, _getCoursesOfTheWeek, _getNextChallenge, _getOrganizations, _getSnapshots, _getSolutions, _patchAnswer, _postAnswers, _postAssessments, _postAuthentications, _postCertificationCourse, _postFeedbacks, _postRefreshSolution, _emberCliMirage) {
  'use strict';
  ...
  exports.default = function () {
    ...
    this.get('/solutions', _getSolutions.default);
...
define('pix-live/mirage/factories/solution', ['exports', 'ember-cli-mirage'], function (exports, _emberCliMirage) {
  'use strict';
...
define("pix-live/mirage/routes/get-solutions", ["exports"], function (exports) {
  "use strict";
  ...
  exports.default = _baseRoute.default.extend(_route.default, {
    model: function model(params) {
      ...
      return Ember.RSVP.hash({
        index: index,
        answer: answer,
        solution: store.query('solution', { answerId: answerId }).then(function (solutions) {
          return solutions.get('firstObject');
        }),
...
define('pix-live/tests/mirage/mirage.lint-test', [], function () {
  ...
  describe('ESLint | mirage', function () {
    ...
    it('mirage/factories/solution.js', function () {
      // test passed
    });
    ...
    it('mirage/routes/get-solutions.js', function () {
      // test passed
    });
